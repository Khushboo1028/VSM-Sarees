...
public class CustomSwipeAdapterLeft extends PagerAdapter {
    ...
    public CustomSwipeAdapterLeft(Activity activity, ArrayList<String> imageUrlList, ArrayList<ContentsCatalogue> catalogueList,ArrayList<ContentsUser> userArrayList) {
    ...
    public Object instantiateItem(@NonNull ViewGroup container, final int position) {
        ...
        Shader textShader=new LinearGradient(0,0,0,0, new int[]{activity.getApplicationContext().getColor(R.color.colorSecondaryRed),activity.getApplicationContext().getColor(R.color.colorSecondaryOrange)},
                new float[]{0,1}, Shader.TileMode.CLAMP);

        textView.getPaint().setShader(textShader);
        textView.setText(activity.getApplicationContext().getString(R.string.bottom_collections_left_text));
        ...
        itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("header",activity.getApplicationContext().getResources().getString(R.string.bottom_collections_left_text));
